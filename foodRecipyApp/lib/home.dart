...
import 'package:foodrecipyapp/Search.dart';
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  children: [
                    Text("WHAT DO YOU WANT TO COOK TODAY ?",style: TextStyle(color: Colors.white,fontSize: 33),),
                    SizedBox(height: 10,),
                    Text("Lets Cook Something New",style: TextStyle(color: Colors.white,fontSize: 20),)
                  ],
                ),
                  ...
                  child: ListView.builder( itemCount: reciptCatList.length, shrinkWrap: true,
                      ...
                      itemBuilder: (context, index){
                        ...
                        return Container(
                            child: InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder:(context)=> Search(reciptCatList[index]["imgUrl"])));
                              },
                              child: Card(
                                  margin: EdgeInsets.all(20),
                                  shape: RoundedRectangleBorder(
